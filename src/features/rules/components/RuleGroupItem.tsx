...
export function RuleGroupItem({
  ...
  onRename,
  onDelete,
}: RuleGroupItemProps): React.JSX.Element {
  return (
    <ContextMenu>
...
interface DraggableRuleGroupItemProps {
  children: React.ReactNode;
  dragControls: ReturnType<typeof useDragControls>;
}

export function DraggableRuleGroupItem({ children, dragControls }: DraggableRuleGroupItemProps): React.JSX.Element {
  return (
...
interface ReorderableGroupItemProps {
  children: React.ReactNode;
  [key: string]: unknown;
}

export function ReorderableGroupItem({ children, ...reorderItemProps }: ReorderableGroupItemProps): React.JSX.Element {
